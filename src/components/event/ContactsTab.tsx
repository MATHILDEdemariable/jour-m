    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        <Button
          ...
          className={`flex-1 ${activeSection === 'team' ? 'bg-gradient-to-r from-purple-600 to-pink-600' : ''}`}
        >
        ...
        <Button
          ...
          className={`flex-1 ${activeSection === 'vendors' ? 'bg-gradient-to-r from-purple-600 to-pink-600' : ''}`}
        >
      ...
      {activeSection === 'team' && (
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">Contacts de tous les membres de l'équipe</p>
          </CardHeader>
          <CardContent>
            {people.length === 0 ? (
                ...
                {people.map((person) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600">{person.role || 'Membre de l\'équipe'}</p>
                    </div>
      ...
      {activeSection === 'vendors' && (
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">Contacts de tous les prestataires de l'événement</p>
          </CardHeader>
          <CardContent>
            {vendors.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                {vendors.map((vendor) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600">{vendor.service_type || 'Prestataire'}</p>
